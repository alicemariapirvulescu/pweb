...
function getWebpackConfigs(options, context) {
    ...
    return [
        ...
        if (options.webpackConfig) {
            const customWebpack = (0, custom_webpack_1.resolveCustomWebpackConfig)(options.webpackConfig, options.tsConfig);
...
function run(options, context) {
    ...
    return (0, tslib_1.__asyncGenerator)(this, arguments, function* run_1() {
        ...
        if (!options.buildLibsFromSource && context.targetName) {
            const { dependencies } = (0, buildable_libs_utils_1.calculateProjectDependencies)((0, project_graph_1.readCachedProjectGraph)(), context.root, context.projectName, context.targetName, context.configurationName);
        ...
        return yield (0, tslib_1.__await)(yield (0, tslib_1.__await)(yield* (0, tslib_1.__asyncDelegator)((0, tslib_1.__asyncValues)((0, rxjs_for_await_1.eachValueFrom)((0, rxjs_1.from)(configs).pipe((0, operators_1.mergeMap)((config) => (Array.isArray(config) ? (0, rxjs_1.from)(config) : (0, rxjs_1.of)(config))), 
        ...
        (0, operators_1.bufferCount)(configs.length), (0, operators_1.switchMap)(([result1, result2]) => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
