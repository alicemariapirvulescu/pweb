...
function findMainRenderStatement(source) {
    ...
    const imports = (0, find_nodes_1.findNodes)(source, ts.SyntaxKind.ImportDeclaration);
...
function findDefaultExportDeclaration(source) {
    ...
    if (identifier) {
        const variables = (0, find_nodes_1.findNodes)(source, ts.SyntaxKind.VariableDeclaration);
        const fns = (0, find_nodes_1.findNodes)(source, ts.SyntaxKind.FunctionDeclaration);
        const cls = (0, find_nodes_1.findNodes)(source, ts.SyntaxKind.ClassDeclaration);
...
function findDefaultExportIdentifier(source) {
    const exports = (0, find_nodes_1.findNodes)(source, ts.SyntaxKind.ExportAssignment);
...
function findElements(source, tagName) {
    const nodes = (0, find_nodes_1.findNodes)(source, [
...
function addInitialRoutes(sourcePath, source) {
    const jsxClosingElements = (0, find_nodes_1.findNodes)(source, [
...
function getComponentName(sourceFile) {
    ...
    if (!(defaultExport &&
        ((0, find_nodes_1.findNodes)(defaultExport, ts.SyntaxKind.JsxElement).length > 0 ||
            (0, find_nodes_1.findNodes)(defaultExport, ts.SyntaxKind.JsxSelfClosingElement).length >
                0))) {
        return null;
    }
...
function getComponentPropsInterface(sourceFile) {
    ...
    if (propsTypeName) {
        return (0, find_nodes_1.findNodes)(sourceFile, ts.SyntaxKind.InterfaceDeclaration).find((x) => {
