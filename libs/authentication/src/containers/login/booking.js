...
const Booking = () => {
    ...
    const renderFooter = (name) => {
        return (
            <div>
                ...
                <InputTextarea style={{ width: '50rem' , marginTop: "1rem"}} value={message} onChange={(e) => setMessage(e.target.value)} rows={5} cols={32} />
    ...
    return (
        ...
        <div >
            ...
            <Dialog header="Make a booking" className='reservation-card' visible={enableReservation}
                position='right'
            ...
            <Dialog visible={showMessage} onHide={() => setShowMessage(false)} position="top" footer={dialogFooter} showHeader={false} breakpoints={{ '960px': '80vw' }} style={{ width: '30vw' }}>
                <div className="flex align-items-center flex-column pt-6 px-3">
                    ...
                    <p style={{ lineHeight: 1.5, textIndent: '1rem' }}>
                        When the owner checks your request, you will see the statusa accepted on the reservations tab.
                    </p>
                </div>
            </Dialog>
        </div>
