    ...
    if (emotionReactVersion &&
        ...
        if ((_a = babelrc === null || babelrc === void 0 ? void 0 : babelrc.plugins) === null || _a === void 0 ? void 0 : _a.includes('@emotion/babel-plugin')) {
            resolvedEmotionAliases = {
                resolve: {
                    alias: {
                        '@emotion/core': (0, devkit_1.joinPathFragments)(app_root_1.appRootPath, 'node_modules', '@emotion/react'),
                        '@emotion/styled': (0, devkit_1.joinPathFragments)(app_root_1.appRootPath, 'node_modules', '@emotion/styled'),
                        'emotion-theming': (0, devkit_1.joinPathFragments)(app_root_1.appRootPath, 'node_modules', '@emotion/react'),
                    },
                },
            };
        }
